label ch3_main:
    ...
    mc "Merak etme, ben de yeni geldim."
    ...
    y 1m "Çok kararlı olmalısınız."
    y "Bu kulübe başlamak ve şimdi de piyano çalmak..."
    show yuri 1a at t32 zorder 2
    show monika at f31 zorder 3
    m 1a "Belki kararlılık değil..."
    m "Ama sanırım tutku."
    m "Unutmayın ki sizler olmasaydınız bu kulüp burada olmazdı."
    m 1b "Ve hepinizin festival için yardım etmeye istekli olmanızdan da çok mutluyum!"
    show natsuki 1z at f33 zorder 3
    show monika at t31 zorder 2
    n "Aaah, festival için sabırsızlanıyorum!"
    n "Harika olacak!"
    show natsuki at t33 zorder 2
    show monika at f31 zorder 3
    m 1d "Eh?"
    m "Daha dün bundan şikayetçi değil miydin, Natsuki?"
    show monika at t31 zorder 2
    show natsuki 2a at f33 zorder 3
    n "Şey, evet."
    n "Festivalin {i}bizim{/i} bölümünden bahsetmiyorum."
    n 4l "Ama okulda oyun oynadığımız ve her türlü lezzetli yemeği yediğimiz koca bir gün!"
    show natsuki at t33 zorder 2
    mc "Birdenbire Sayori gibi konuşmaya başladın..."
    show natsuki at f33 zorder 3
    n 4a "Monika! Genelde kızarmış kalamar var mı?"
    show natsuki at t33 zorder 2
    show monika 2a at f31 zorder 3
    m "Kalamar...?"
    m "Bu dört gözle beklenecek oldukça özel bir şey..."
    show monika at t31 zorder 2
    show natsuki 2k at f33 zorder 3
    n "Oh, hadi ama."
    n "Kalamar sevmediğini mi söylüyorsun?"
    n "Tüm insanlar arasında, sen?"
    show natsuki at t33 zorder 2
    show monika 1d at f31 zorder 3
    m "Ne? Sevmediğimi söylemedim."
    m "Ayrıca, 'tüm insanlar arasında sen' derken neyi kastediyorsun?"
    show monika at t31 zorder 2
    show natsuki 1d at f33 zorder 3
    n "Çünkü!"
    n "Bu senin adında var!"
    n 4z "Mon-ika!"
    show natsuki at t33 zorder 2
    show monika 5b at f31 zorder 3
    m "Eh?!"
    m "İsmimi hiç de öyle söylemiyorsun!"
    m "Ayrıca, bu şaka çeviride hiçbir anlam ifade etmiyor!"
    show monika at t31 zorder 2
    show natsuki at f33 zorder 3
    n 4m "...?"
    show natsuki at t33 zorder 2
    ...
    m "Ah... boş ver!"
    m "Şimdilik sadece kendi etkinliğimize odaklanalım, tamam mı?"
    show monika at t31 zorder 2
    show natsuki 2a at f33 zorder 3
    n "Ehehe."
    n "Tamam, tamam."
    n "Senin tepkilerin Yuri'ninki ya da Sayori'ninki kadar eğlenceli değil zaten."
    show natsuki at t33 zorder 2
    show yuri 2h at f32 zorder 3
    y "Affedersin..."
    show yuri at t32 zorder 2
    mc "Sayori nerede bu arada...?"
    mc "Oh, işte buradasın."
    hide monika
    hide yuri
    hide natsuki
    with wipeleft
    "Sayori odanın köşesindeki masada oturmuş, hiçbir şeye bakmıyor."
    "Ona doğru yürüdüm."
    mc "Hey, Sayori." #ah benim üzümlü kekim...
    ...
    s 4l "Ehehe, üzgünüm..."
    s "Bana aldırma."
    s 4y "Gidip diğerleriyle konuşabilirsin."
    mc "Huh..."
    mc "Her şey yolunda mı?"
    s 1h "Tabii ki!"
    s "Neden olmasın ki?"
    mc "Sadece biraz garip hissediyorum..."
    mc "Varsayımlarda bulunduğum için özür dilerim."
    s "Tanrım, benim için çok fazla endişeleniyorsun."
    s 4r "Ben iyiyim, gördün mü?" #ben kötü bir insanım.
    show sayori at h11
    "Sayori bana kocaman bir gülümseme gösteriyor."
    s 1a "Herkesle eğlenirken dikkatini dağıtmama izin verme."
    mc "Peki...tamam."
    mc "Sen öyle diyorsan."
    show sayori at thide zorder 1
    hide sayori
    "Diğerlerine dönmeden önce endişeyle Sayori'ye bakıyorum."
    "Ama sohbet çoktan dağılmış, herkes olağan faaliyetlerine geri dönmüştü."
    "Belki de Monika'ya son zamanlarda Sayori ile ilgili bir şey fark edip etmediğini sormalıyım..."
    "Festivale hazırlandıklarına göre, birlikte çok zaman geçiriyor olmalılar."
    "Masasında bazı kağıtları karıştıran Monika'ya çekingen bir şekilde yaklaştım."
    show monika 2b at t11 zorder 2
    m "[player]! N'aber?"
    mc "Hey, bu biraz garip gelebilir ama..."
    mc "Son zamanlarda Sayori ile ilgili bir şey fark ettin mi?"
    m 1d "Onunla ilgili bir şey...?"
    m "Nasıl yani?"
    mc "Belki biraz fazla yorumluyorum ama bugün biraz keyifsiz görünüyor..."
    m "Oh? Öyle mi düşünüyorsun?"
    m "Onunla ilgili bir şey fark ettiğimi söyleyemem..."
    "Monika odanın öbür ucunda, masasında lastik silgiyi bir aşağı bir yukarı sürükleyen Sayori'ye bakıyor."
    m "Belki de aklında bir şeyler vardır..."
    m 2a "Ama bunu sana soranın ben olmamama şaşırdım, [player]."
    m "Onu benden çok daha iyi tanıdığın kesin."
    mc "Evet, ama o hiç böyle değildi..."
    mc "Onu rahatsız eden şeyler hakkında benimle hep konuşurdu."
    mc "Ama bu sefer, ona sorduğumda, gerçekten umursamazdı."
    mc "...Üzgünüm, bunun senin sorunun olmadığını biliyorum!"
    mc "Sadece bir şey bilip bilmediğini sormak istemiştim, o yüzden şimdi bırakıyorum..."
    m 1g "Hayır, hayır..."
    m "Bu benim için de önemli."
    m 1e "Yani, ben de onun arkadaşıyım..."
    m "Ayrıca kulüp üyelerimin iyiliğini de önemsiyorum, anlıyor musun?"
    m 1i "Belki onunla kendim konuşmayı denerim..."
    mc "Eh? Bundan emin misin...?"
    mc "Yalnız kalmak istiyor gibi görünüyordu..."
    m "Emin misin?"
    m "Belki de bu konuyu ilgili kişiye açmakta zorlanıyordur..."
    mc "İlgili kişi...?"
    mc "Bununla ne demek istiyorsun?"
    m 2e "Diyorum ki belki de aklında olan şey sensindir, [player]."
    mc "Ben...?"
    mc "Bu sonuca nasıl vardın?"
    m 1j "Şey..."
    m "Muhtemelen çok fazla şey söylememeliyim ama..."
    m 1a "Sayori her şeyden çok senin hakkında konuşuyor, biliyor musun?"
    mc "Eh...?"
    m "Sen kulübe katıldığından beri çok daha mutlu."
    m "Sanki içinde fazladan bir ışık yanıyor."
    mc "Ne?"
    mc "Olamaz..."
    mc "Sayori...her zaman böyledir."
    mc "O her zaman güneş ışığıyla doluydu."
    mc "Şimdi de her zaman olduğundan farklı değil."
    m 5 "Ehehe."
    m "Çok komiksin, [player]."
    m "Belki de onu her zaman çok neşeli gördüğünü düşündün mü..."
    m "...çünkü senin yanındayken öyle olduğu için mi?"
    mc "..."
    m 1n "Ah... Çok fazla şey söyledim."
    m "Özür dilerim... Ben ne bilirim ki?"
    m 1a "Hemen sonuca varmak istememiştim, bu yüzden söylediklerimi unutmalısın."
    m "Onunla konuşmaya çalışacağım, o yüzden şimdilik bunu düşünmemeye çalış."
    mc "Ah..."
    mc "Pekala..."
    "Monika anlamlı bir şekilde gülümser."
    "Bunu unutmamı söylediğini biliyorum..."
    "Ama onun sözlerini aklımdan çıkaramayacağımı şimdiden biliyorum."
    show monika at thide zorder 1
    hide monika
    "Monika masasından kalkıyor ve odanın diğer ucuna, Sayori'nin oturduğu yere doğru yürüyor."
    "Sayori'nin yanına diz çöküp onunla nazikçe konuşmasını izliyorum."
    "Ama sesini o kadar alçak tutuyor ki buradan onu duyamıyorum."
    "İçimi çekiyorum ve oturuyorum."
    "Sayori'nin bana onun için endişelenmememi ve diğer herkesle eğlenmemi söylediğini biliyorum..."
    "Ama o böyle davranırken bunu yapmak imkansız."
    "Onu tam olarak ne kadar önemsiyorum ki, bunun beni bu kadar yormasına izin veriyorum?"
    "Şimdi sıra dışı davranan benmişim gibi geliyor..."
    "Ama Monika'yı beklemekten başka yapabileceğim bir şey yok."
...
label ch3_start_natsuki:
    ...
    n "Hey, sen."
    mc "Eh?"
    "Kafamı kaldırdığımda Natsuki'nin yanımda olduğunu gördüm."
    n "Orada öylece oturup boş boş bakmaya devam mı edeceksin?"
    n "Çok fazla zaman yok, o yüzden..."
    mc "Ah, özür dilerim."
    mc "Seni endişelendirmek istememiştim."
    n 1q "Endişelendiğimden değil!"
    n "Ben sadece..."
    "Natsuki yan tarafına bakar."
    "Elinde bir manga cildi tutuyor."
    mc "Doğru..."
    mc "Bir dakikalığına bir şey çıktı, ama şimdi başlayabiliriz."
    mc "Seni daha fazla bekletmeyeceğim."
    n 5n "Tanrım..."
    n "Şimdi kendimi bir pislik gibi hissettiriyorsun."
    n "Eğer seni rahatsız eden bir şey varsa, o zaman bana seni yalnız bırakmamı söyleyebilirsin, ben de bırakırım."
    n 5u "Yani..."
    n "Bunun hakkında konuşmak istemediğini varsayarsak..."
    "Son kısmı neredeyse mırıldanıyor."
    mc "Hayır... Muhtemelen olduğundan daha büyük bir mesele gibi gösteriyorum."
    mc "Sadece Sayori'yi düşünüyordum, hepsi bu."
    n 1p "S-Sayori...?"
    "Onu düşünüyorsun...?"
    mc "Evet, bugün oldukça üzgün görünüyor."
    mc "Ama bunu bana itiraf etmek istemedi."
    mc "Bu yüzden ona bir şey mi oldu diye düşünmeden edemiyorum."
    n 1q "Oh..."
    "Natsuki nefes verir."
    n 4w "Şey, her şeyden önce..."
    n "İfadelerin üzerinde gerçekten çalışmalısın!"
    n 4c "Ama her neyse..."
    n "Sen onun en iyi arkadaşısın, değil mi?"
    mc "Evet, sanırım öyle..."
    n "Evet."
    n 3k "O halde, bence ona biraz daha güvenmelisin."
    n "Eğer sana ihtiyacı olsaydı, gideceği ilk kişi sen olurdun, değil mi?"
    mc "Şey... Sanırım bu doğru."
    n 3c "Yani, bazı insanların öyle günleri olur."
    n "Her zaman bundan kaçınamazsın."
    n "Eğer bir şey varsa, muhtemelen onun hakkında endişelenmenizi istemiyordur çünkü önemli değildir."
    mc "Evet, bana da öyle demişti..."
    mc "Belki de onun isteklerine karşı gelmek benim için doğru değildir."
    n 3a "Kesinlikle."
    n "Eğer onun için endişelenmene ihtiyacı varsa, o zaman bu çok daha açık olacaktır."
    mc "Evet..."
    mc "Başından beri bu şekilde düşünmeliydim."
    show natsuki 3q
    "Natsuki elinde tuttuğu kitapla oynuyor."
    n 1q "O..."
    n "O senin için gerçekten çok şey ifade ediyor, değil mi...?"
    mc "Ah--"
    mc "Yanlış bir fikre kapılmayın...!"
    mc "Biz sadece uzun zamandır arkadaşız."
    mc "Arkadaşların için endişelenmen normal."
    mc "Yani, sen de benim için endişeleniyordun, yani--"
    n 4w "Değildim!!"
    n "Tanrım... eğer iyiysen, o zaman acele edelim ve başlayalım!"
    mc "Evet, evet..."
...
label ch3_start_yuri:
    "Neden izleniyormuşum gibi hissediyorum...?"
    "Odanın etrafına bakıyorum."
    show yuri 2t at t11 zorder 2
    "Birden Yuri'nin kitabının üzerinden bana baktığını fark ettim."
    show yuri 4b
    "Ama yüzünde telaşlı bir ifadeyle aynı hızla gözlerini kaçırıyor."
    "Bu şekilde bir yere varamayacağının farkındayım."
    "Yuri'nin kimseye yaklaştığını ya da kendi başına bir konuşma başlattığını hiç görmedim."
    "Bu yüzden ona kendim yaklaşmaktan başka çarem yok."
    "Şimdiye kadar bunu yapmak benim için biraz daha kolay oldu."
    "Kendi masamdan kalkıp onunkinin yanına oturuyorum."
    play music t6 fadeout 1
    y 2v "..."
    y "Ben... sizi rahatsız etmek istemedim..."
    mc "Sakin ol, bir şey yapmadın bile."
    y "Ama..."
    y "Düşüncelerinle yalnız kalmak istediğini söyleyebilirim..."
    mc "Düşüncelerimle yalnız...?"
    mc "Böyle düşündüğümü nasıl anladın?"
    y 1t "Şey..."
    y "Bu benim çok yaptığım bir şey..."
    y "Yani duruşunuzdan ve yüz ifadenizden bunu anlamak benim için zor olmadı."
    y 3o "Baktığımdan falan değil...!"
    y "Öyle ürkütücü bir şey yapmadım...!"
    mc "Her halükarda, sanırım haklıydın."
    mc "Sizi endişelendirdiysem özür dilerim."
    y 1s "Özür dileme..."
    y "Dertleriniz yalnızca bu dertleri paylaşmaya gönüllü olanları ilgilendirir."
    y "Elbette, en büyük rahatlığı kendi içlerine kapanmakta bulanlar da var..."
    y "Ama aklınızdan geçenleri paylaşmayı tercih ederseniz, dinlemekten memnuniyet duyarım."
    mc "Ah, gerçekten o kadar da büyük bir mesele değil..."
    mc "Sadece Sayori hakkında biraz huzursuz hissediyordum."
    y 2t "Sayori...?"
    mc "Evet... bugün biraz keyifsiz görünüyor, ama bunu ona sorduğumda bana itiraf etmek istemedi."
    mc "Bu yüzden ona bir şey mi oldu diye düşünmeden edemiyorum."
    y 3u "Oh?"
    y "Bu oldukça romantik..."
    mc "Eh...?"
    y 4c "Özür dilerim!"
    y "Aptalca bir şey söylemek istememiştim...!"
    mc "Öyle değil, sadece yanlış anlamanı istemedim."
    mc "Sayori ve ben sadece uzun zamandır arkadaşız, hepsi bu."
    y 2l "Ah... Anlıyorum..."
    y 2f "O zaman belki de duyguları konusunda size karşı umursamaz davranması alışılmadık bir durumdur..."
    mc "Ya da belki de ben biraz fazla yorumluyorum..."
    y 1u "[player]..."
    y "Dünya anlamlarla doludur, çoğu zaman gözün göremeyeceği derinliklerde gizlidir."
    y 1s "Ve ne kadar iyi tanıyor olursanız olun, her insanın ardında anlatılmamış pek çok gizem vardır."
    mc "Ah..."
    mc "Yani her şeye rağmen bunun arkasında bir şeyler olabileceğini mi düşünüyorsunuz?"
    y 1l "Mm..."
    y "Sayori'nin çok karmaşık bir insan olduğunu düşünüyorum."
    y 1h "Dışarıdaki tavırları kafasının içinde olup bitenlerle her zaman uyuşmayabilir..."
    y "Ve her zaman ne istediğini bilmiyor olabilir."
    y "Bugünkü garip davranışlarını ben de fark ettim..."
    y "Ve ayrıca onun için biraz endişe duyuyorum."
    y 1f "Ama sizin durumunuzda, düşüncelerinizi tamamen işgal ediyor gibi görünüyordu, değil mi?"
    mc "Şey..."
    mc "Sanırım durum buydu."
    y 3u "Sayori..."
    y "O senin için gerçekten çok şey ifade ediyor, değil mi?"
    mc "Ah--Ben...Sanırım..."
    mc "Ama bu şekilde ifade etmene gerek yok!"
    mc "Biz sadece iyi arkadaşız, hepsi bu..."
    y 2t "..."
    "Yuri birden gözlerimin içine baktı."
    "Yüz ifadesi nazik ve meraklı, sanki bir şey arıyormuş gibi."
    "Utandım, bakışlarımı kaçırdım."
    y 2m "Bazen..."
    y "Bir insanın gizemleri kendisine bile anlatılamaz."
    y 2a "Ve sen, dürüst ve şefkatli biri olarak..."
    y "İçinde olduğunu bilmediğin duyguları ortaya çıkarabilirsin."
    y 4b "Bu..."
    y "Bence..."
    y "O çok şanslı bir insan olurdu..."
    y "Onun hakkında böyle hissettiğin için..."
    mc "Yuri..."
    mc "Bana çok fazla kredi veriyorsun."
    mc "Ben oldukça basit bir adamım."
    mc "Bu yüzden kendi duygularımı anlamakta oldukça iyi olduğumu düşünüyorum."
    mc "Senin kadar sofistike değilim."
    y 2t "A-Ah..."
    y "Bu... bir iltifat değil, değil mi?"
    mc "Neyse o."
    mc "Her neyse, madem buradayız, neden biraz kitap okumuyoruz?"
    y 2s "Şey..."
    y "Senin için sorun olmadığı sürece."
    mc "Evet."
    mc "Zaten tüm bu olanlardan kafamı kaldırmam gerekiyor."
...
label ch3_start_none:
    ...
    m "Tamam, millet!"
    "Bir süre geçtikten sonra Monika kulüp odasına seslenir."
    m "Neden şimdi şiirlerimizi paylaşmıyoruz?"
    show monika at thide zorder 1
    hide monika
    "Ne olduğunu anlamadan her şey normale dönüyor."
    "Herkes şiirlerini almaya gidiyor ve ben de aynısını yapıyorum."
    "Monika ile göz göze geldim ve o da bana gülümsedi."
    "Sayori ile ne konuştuğunu merak ediyorum..."
    return
...
label ch3_end:
    ...
    play music t3
    m "...Tamam, siz üçünüz!"
    m "Hepimiz şiirleri paylaşmayı bitirdik, değil mi?"
    m "Neden anlamaya başlamıyoruz--"
    show natsuki 3c at f31 zorder 3
    n "Bir saniye bekle!"
    n "Bana mı öyle geliyor, yoksa az önce garip bir şey mi söyledin?"
